   ...
   <footer className='small_screen_footer containers flex flex-col w-full gap-[20px] py-[100px] px-[20px]'>
           <div className="flex flex-col   gap-[20px]">
                ...
                <div className="flex items-center  w-full gap-[10px]">
                   <button className="flex justify-center items-center gap-[12px] text-[16px] font-bold rounded-[7px] w-[250px] h-[65px] cursor-pointer bg-[#EBEFF3]"><AppStore/>App Store</button>
                   <button className="flex justify-center items-center gap-[12px] text-[16px] font-bold rounded-[7px] w-[250px] h-[65px] cursor-pointer bg-[#EBEFF3]"><Play/>Google Play</button>
                </div>
            </div>
            ...
            <ul className="flex flex-col gap-[12px]">
              <li className="list-none text-[16px] text-[#000000B2] cursor-pointer">{t("about")}</li>
              <li className="list-none text-[16px] text-[#000000B2] cursor-pointer">{t("terms")}</li>
              <li className="list-none text-[16px] text-[#000000B2] cursor-pointer w-[60%]">{t("privacy")}</li>
              <li className="list-none text-[16px] text-[#000000B2] cursor-pointer w-[60%]">{t("returnItem")}</li>
              <li className="list-none text-[16px] text-[#000000B2] cursor-pointer">{t("contactUs")}</li>
            </ul>
            <p className="text-[12px] text-[#00000066]">{t("date")}</p>
            </div>
