...
const Hero = () => {
  ...
  return (
    <div className="w-full bg-[#F3F0F0] hero_content_wrapper h-[450px]">
            ...
            <SwiperSlide>
                <div className="flex items-center justify-between">
                     <div className="absolute left-0 right-0 flex flex-col items-start text-start gap-[20px] ">
                          <h2 className="hero_main_title w-[80%]  font-black text-[44px] text-[#0A1729] leading-[120%]">{item.name}</h2>
