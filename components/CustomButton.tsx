...
const CustomButton:FC<CustomButtonType> = ({onClick,bage, extraClass, children, icon, iconPosition}) => {
  return (
    <button onClick={onClick} className={`${extraClass} relative flex py-[14px] px-[25px] text-[16px] bg-[#134E9B] font-semibold rounded-[6px] items-center justify-center gap-[20px]`}>
